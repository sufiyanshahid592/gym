...
$working_dir = getcwd();
$working_dir = explode("/",$working_dir);
$dir_length = count($working_dir);
$dir_length = $dir_length-3;
//$upload_dir = $working_dir[$dir_length].'/images/blog/';
$upload_dir = "images/blog/";
//echo $_SERVER['DOCUMENT_ROOT'].$upload_dir;
//exit;

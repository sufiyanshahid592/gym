...
<div class="right_col" role="main">
    ...
    @foreach ($edit_view as $editdata)
        <form class="form px-sm-4" method="post" action="{{ url('/updateblog/'. $editdata->id ) }}" enctype="multipart/form-data" >
            @csrf

            <div class="row">
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText1" type="text" name="blogtitle" class="form-control" value="{{ $editdata->blog_title }}"  />
                        <label for="inputText1" class="col-form-label">Blog Title</label>
                    </div>
                </div>
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText2" type="text" name="blogurl" class="form-control" value="{{ $editdata->blog_url }}"  />
                ...
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText4" type="text" name="metadescription" value="{{ $editdata->meta_description }}" class="form-control" />
                ...
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText5" type="text" name="metatags" value="{{ $editdata->meta_tags }}" class="form-control" />
                        <label for="inputText5" class="col-form-label">Meta Tags</label>
                    </div>
                </div>
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText6" type="text" name="authorname" value="{{ $editdata->author_name }}" class="form-control" />
                ...
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <textarea class="form-control bg-light small" id="editor1"  required="required" name="longdescription"> {{ $editdata->blog_long_desc }} </textarea>
                ...
                <div  class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText10" type="text" name="altname" value="{{ $editdata->blog_altname }}" class="form-control" />

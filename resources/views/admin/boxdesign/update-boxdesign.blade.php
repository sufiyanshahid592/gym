                ...
                <div class="row">
                    <div class="col-md-12 mb-sm-4">
                        <div class="form-group material-style">
                            <input id="inputText1" type="text" name="box_name"  value="{{  $edit_item->box_name }}" class="form-control bg-light smalll" required=" required" />
                    ...
                    <div class="col-md-12 mb-sm-4">
                        <div class="form-group material-style">
                            <textarea class="form-control" id="editor1" required="required" name="box_desc"> {{ $edit_item->box_desc }} </textarea>
                    ...
                    <div class="col-md-12 mb-sm-4">
                        <div class="form-group material-style">
                            <input id="inputText2" type="text" name="box_link" value="{{  $edit_item->box_link }}" class="form-control bg-light smalll"  />

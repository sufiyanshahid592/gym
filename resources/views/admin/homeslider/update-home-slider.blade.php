            ...
            <div class="row">
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="minititle" class="form-control" value="{{ $singleData->mini_title }}" required=" required" />
                        <label for="inputText3" class="col-form-label"> Mini Title </label>
                    </div>
                </div>
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="bigtitle" class="form-control" value="{{ $singleData->big_title }}" required=" required" />
                ...
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="sliderdesc" value="{{ $singleData->slider_description }}" class="form-control"  />
                ...
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="file" name="banner" class="form-control" />
                ...
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="altname" value="{{ $singleData->slider_altname }}"  class="form-control" />
                ...
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="button_link" value="{{ $singleData->button_link }}" class="form-control"  />
                ...
                <div class="col-md-12 mb-sm-4">
                    <div class="form-group material-style">
                        <input id="inputText3" type="text" name="button_text" value="{{ $singleData->button_text }}" class="form-control"  />
